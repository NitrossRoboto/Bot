...
module.exports = {
    VERSION: 'v1.0.0 Starter Release',
    CHANNEL: 'https://github.com/NitrossRoboto/Bot',
    SESSION: process.env.A_NITROSS_SESSION === undefined ? '' : process.env.A_NITROSS_SESSION,
    ...
    MENUCOMMAND: process.env.MENU_COMMAND === undefined ? 'menu' : process.env.MENU_COMMAND,
