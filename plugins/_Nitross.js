...
const MTEXT = '\n*꧁𓊈𒆜🅱🅾🆃 🅸🅽🅵🅾𒆜𓊉꧂*\n\nHay Im '+Config.BOT+',\n\n'+Config.MENUTEXT+'\n\n★彡[ Contact Owner: *wa.me/'+Config.OWNERNUM+'*\n★彡[ Version: *'+Config.VERSION+'*\n★彡[ Branch: *'+Config.BRANCH+'*\n★彡[ Language: *EN*\n★彡[ Work Type: *'+Config.WORKTYPE+'*\n\n\n   *🌷😲 Nitross Roboto Commands Menu 💝♙*\n\n'
    ...
    Nitross.addCommand({pattern: 'menu ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
        
        var CMD_HELP = '';
        if (match[1] === '') {
            Nitross.commands.map(
                async (command) =>  {
    ...
    Nitross.addCommand({pattern: 'help ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Nitross.addCommand({pattern: 'list ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
    ...
    Nitross.addCommand({pattern: 'මෙනු ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
