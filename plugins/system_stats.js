...
if (Config.ALIVE_IMG_TYPE == 'pp') {
    ...
    NitrossBot.addCommand({pattern: 'alive', fromMe: rn, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    NitrossBot.addCommand({pattern: 'sysd', fromMe: rn, desc: Lang.SYSD_DESC}, (async (message, match) => {
