...
const  Anim = "Get animation videos";
    ...
    NitrossBotBot.addCommand({pattern: 'darkjoke', fromMe: true, desc: Anim}, (async (message, match) => {
...
NitrossBotBot.addCommand({pattern: 'darkjokes', fromMe: false, desc: Anim}, (async (message, match) => {
