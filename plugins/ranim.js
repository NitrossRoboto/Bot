...
const  Anim = "Get animation videos";
    ...
    NitrossBot.addCommand({pattern: 'anim', fromMe: true, desc: Anim}, (async (message, match) => {
...
NitrossBot.addCommand({pattern: 'anim', fromMe: false, desc: Anim}, (async (message, match) => {
