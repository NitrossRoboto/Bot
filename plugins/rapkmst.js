...
const Apk = "NitrossBot MOD STORE";

if (Config.WORKTYPE == 'private') {

     NitrossBot.addCommand({ pattern: 'rapkmod ?(.*)', fromMe: true,desc: Apk}, (async (message, match) => {

        await message.sendMessage("*╔═▣═══❖⦁⦁⦁💢⦁⦁⦁❖═══▣═╗*\n║  *🤴NitrossBot MOD STORE🤴*  ║\n*╚═══❖═══▣ ╩ ▣════❖═══╝*\n\n*මෙමෙ ඇප් සියල්ල බොට් හරහා ලබාගත හැක.*\n\n*|🔰NitrossBot WA MOD v1 - .rawamo*\n\n*|🔰Video Marker v1.61 premium - .ravm*\n\n*|🔰VivaVideo 8.11.3 p - .ravv*\n\n*|🔰Piscart gold full v.17.3.1  - .rapa*\n\n*|🔰PLAYit v2.5.8.14 vip - .rapy*\n\n*|🔰Dual Space Lite v3.1.1 vip - .rads*\n\n*|🔰Glitch video efct pro- .ragve*\n\n*|🔰Photo editer v6.9 pro - .rape*\n\n\n*තවත් ඇප් ඉදිරියේදී එකතුවේ..*\n________________________");    

    }));

NitrossBot.addCommand({ pattern: 'rawamo', fromMe: true,dontAddCommandList: true}, (async (message, match) => {

        var webimage = await axios.get(`https://netfile2link.herokuapp.com/85744`, { responseType: 'arraybuffer' })

        await message.sendMessage(Buffer.from(webimage.data), MessageType.document, {filename: 'NitrossBot WA MOD v1.apk', mimetype: 'application/vnd.android.package-archive', quoted: message.data})
        
    }));

NitrossBot.addCommand({ pattern: 'ravm', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'ravv', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rapa', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rapy', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rads', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'ragve', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rape', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
     ...
     NitrossBot.addCommand({ pattern: 'rapkmod ?(.*)', fromMe: false,desc: Apk}, (async (message, match) => {

        await message.sendMessage("*╔═▣═══❖⦁⦁⦁💢⦁⦁⦁❖═══▣═╗*\n║  *🤴NitrossBot MOD STORE🤴*  ║\n*╚═══❖═══▣ ╩ ▣════❖═══╝*\n\n*මෙමෙ ඇප් සියල්ල බොට් හරහා ලබාගත හැක.*\n\n*|🔰NitrossBot WA MOD v1 - .rawamo*\n\n*|🔰Video Marker v1.61 premium - .ravm*\n\n*|🔰VivaVideo 8.11.3 p - .ravv*\n\n*|🔰Piscart gold full v.17.3.1  - .rapa*\n\n*|🔰PLAYit v2.5.8.14 vip - .rapy*\n\n*|🔰Dual Space Lite v3.1.1 vip - .rads*\n\n*|🔰Glitch video efct pro- .ragve*\n\n*|🔰Photo editer v6.9 pro - .rape*\n\n\n*තවත් ඇප් ඉදිරියේදී එකතුවේ..*\n________________________");    

    }));

NitrossBot.addCommand({ pattern: 'rawamo', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'ravm', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'ravv', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rapa', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rapy', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rads', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'ragve', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
NitrossBot.addCommand({ pattern: 'rape', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
