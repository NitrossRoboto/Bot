/*
Nekobin for WhatsNitrossbot - W4RR10R
...
if (Config.WORKTYPE == 'private') {
    ...
    Nitrossbot.addCommand({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Nitrossbot.addCommand({pattern: 'neko', fromMe: false, desc: Lang.NEKO_DESC}, (async (message, match) => {
    ...
    Nitrossbot.addCommand({pattern: 'neko', fromMe: true, desc: Lang.NEKO_DESC, dontAddCommandList: true}, (async (message, match) => {
