...
const HELP = "Bot help Center"
    ...
    Nitross.addCommand({pattern: '7', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*බොට් හට .Nitross හෝ .help ගසන්න.*\n\n🥰Thank you for using Nitross HELP CENTER🇱🇰");
    
    }));
    Nitross.addCommand({pattern: '8', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Nitross.addCommand({pattern: '9', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Nitross.addCommand({pattern: '10', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Nitross.addCommand({pattern: '11', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
