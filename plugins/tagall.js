...
Nitrossbot.addCommand({pattern: 'tagall ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC }, (async (message, match) => {
...
if (Config.LANG == 'SI') stag_dsc = 'उत्तर दिया गया संदेश समूह के सभी सदस्यों को भेजता है'
...
Nitrossbot.addCommand({pattern: 'stam$', fromMe: true, desc: stag_dsc }, (async (message, match) => {
