...
if (pb.WORKTYPE == 'private') {
    Nitrossobot.addCommand({ pattern: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    Nitrossobot.addCommand({ pattern: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
