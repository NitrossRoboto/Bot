...
if (Config.WORKTYPE == 'private') {
    ...
    Nitross.addCMD({pattern: 'png ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
    ...
    Nitross.addCMD({pattern: 'png ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
    ...
    Nitross.addCMD({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
