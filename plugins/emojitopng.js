...
if (Config.WORKTYPE == 'private') {
    ...
    NitrossBot.addCMD({pattern: 'png ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
    ...
    NitrossBot.addCMD({pattern: 'png ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
    ...
    NitrossBot.addCMD({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
