...
if (Config.WORKTYPE == 'private') {
    ...
    Raone.addCMD({pattern: 'png ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
    ...
    Raone.addCMD({pattern: 'png ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
    ...
    Raone.addCMD({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
