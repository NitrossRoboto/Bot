...
if (Config.WORKTYPE == 'private') {
    ...
    NitrossBot.addCommand({pattern: 'play ?(.*)', fromMe: true, desc: Lang.PLAY_DESC}, (async (message, match) => { 
    ...
    NitrossBot.addCommand({ pattern: 'github ?(.*)', fromMe: true, dontAddCommandList: true }, async (message, match) => {
    ...
    NitrossBot.addCommand({pattern: 'tr(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: false}, (async (message, match) => {
    ...
    NitrossBot.addCommand({pattern: 'play ?(.*)', fromMe: false, desc: Lang.PLAY_DESC}, (async (message, match) => { 
